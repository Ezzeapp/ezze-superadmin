...
export default function ProductClient({ product }: { product: string }) {
  ...
  // main (ezze.site) — это лендинг платформы, фичи продуктовые → не показываем
  const showFeaturesTab = product !== "main";
