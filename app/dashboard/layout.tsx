...
import { Zap, CreditCard, Bot, Mail, Palette, LayoutGrid, Info, Users, KeyRound, BookOpen, ContactRound, UsersRound } from "lucide-react";
      ...
      <aside className="w-56 bg-white border-r border-gray-200 dark:bg-gray-900 dark:border-gray-800 flex flex-col shrink-0">
        ...
        <div className="border-t border-gray-200 dark:border-gray-800">
          ...
          <Link
            ...
            className={`${linkBase} ${pathname.startsWith("/dashboard/teams") ? linkActive : linkInactive}`}
          >
            <UsersRound size={14} />
        ...
        <div className="border-t border-gray-200 dark:border-gray-800">
          ...
          {[
            ...
            { href: "/dashboard/tariffs",           icon: CreditCard, label: "Тарифы и платежи" },
