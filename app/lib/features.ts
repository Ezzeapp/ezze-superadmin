...
export const FEATURES: FeatureConfig[] = [
  ...
  { key: "settings_discount_days", label: "Настройки → Скидочные дни",  description: "Вкладка «Скидочные дни» — праздники, конкретные даты и дни недели с авто-скидкой на новые заказы (только cleaning).", defaultPlan: "free", section: "settings" },
